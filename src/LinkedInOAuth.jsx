...
const LINKEDIN_CLIENT_SECRET = 'WPL_AP1.VTQRaBaxVN1EqxQO.aEvK3g==';
const LINKEDIN_CLIENT_ID = '78fucteolzxv60';
const LINKEDIN_CALLBACK_URL = 'http://localhost:5173/account/login';
